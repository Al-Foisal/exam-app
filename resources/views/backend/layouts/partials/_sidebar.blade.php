<nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    <div class="logo d-flex justify-content-between">
        <a href="index-2.html"><img src="{{ asset('backend/img/logo.png') }}" alt></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('backend/img/menu-icon/10.svg') }}" alt>
                </div>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('backend/img/menu-icon/13.svg') }}" alt>
                </div>
                <span>Charts</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('backend/img/menu-icon/14.svg') }}" alt>
                </div>
                <span>Widgets</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('backend/img/menu-icon/15.svg') }}" alt>
                </div>
                <span>Maps</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src="{{ asset('backend/img/menu-icon/16.svg') }}" alt>
                </div>
                <span>Pages</span>
            </a>
            <ul>
