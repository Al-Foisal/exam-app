...
<head>
    ...
    <title>Rest Password - {{ $company->name }}</title>
...
<body>
    ...
    <div class="loginBox"> <img class="user" src="{{ asset($company->logo) }}" height="100px" width="100px">
        ...
        <form action="{{ route('storeResetPassword') }}" method="post">
            ...
            <div class="inputBox">
                <input id="uname" type="text" name="email" value="{{ request()->email }}" placeholder="Email">
                <input id="pass" type="password" name="password" placeholder="Password"> 
                <input id="pass" type="password" name="password_confirmation" placeholder="Confirm password"> 
            </div>
