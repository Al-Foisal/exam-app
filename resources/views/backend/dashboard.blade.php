    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                ...
                <div class="widget-numbers"><span>{{ number_format($total_user) }}</span></div>
        ...
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                ...
                <div class="widget-numbers"><span>{{ number_format($previous_month_total_user) }}</span></div>
                <div class="widget-subheading">Previous Month Registered User</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                ...
                <div class="widget-numbers"><span>{{ number_format($total_teacher) }}</span></div>
                <div class="widget-subheading">Total Teacher</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                <div class="icon-wrapper rounded-circle">
                    <div class="icon-wrapper-bg bg-info"></div>
                    <i class="fas fa-money-bill-wave-alt text-info"></i>
                </div>
                <div class="widget-numbers"><span>{{ number_format($total_pending_amount) }}</span></div>
                <div class="widget-subheading">Total Pending Amount</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                <div class="icon-wrapper rounded-circle">
                    <div class="icon-wrapper-bg bg-info"></div>
                    <i class="fab fa-sellsy text-info"></i>
                </div>
                <div class="widget-numbers"><span>{{ number_format($total_package_sell) }}</span></div>
                <div class="widget-subheading">Total Package Sell</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card mb-3 widget-chart">
                ...
                <div class="widget-numbers"><span>{{ number_format($total_package_sell_amount) }}</span></div>
                <div class="widget-subheading">Total Package Sell Amount</div>
            </div>
        </div>
        <div class="col-12">
...
@section('js')
    ...
    {{-- <script src="{{ asset('backend/vendors/apex_chart/apexchart_lists.js') }}"></script> --}}
    <script>
        $(document).ready(function() {
            var month_name = '{{ $month_name }}';
            var user_count = '{{ $user_count }}';
            var package_sell_count = '{{ $package_sell_count }}';
            var package_sell_amount = '{{ $package_sell_amount }}';
            var options = {
                series: [{
                        name: "Registeded User",
                        data: user_count.split(',')
                    },
                    {
                        name: "Package Sell",
                        data: package_sell_count.split(',')
                    },
                    {
                        name: "Package Sell Amount(K)",
                        data: package_sell_amount.split(','),
                    },
                ],
                chart: {
                    type: "bar",
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/apex_chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Sep 2023 09:16:30 GMT -->
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/apex_chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Sep 2023 09:16:31 GMT -->
