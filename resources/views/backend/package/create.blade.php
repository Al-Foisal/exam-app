                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card p-3 mb-3">
                                        <div class="mb-3 form-check">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" name="permission[Others][Primary]" value="true"
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="amount"
                                        placeholder="Enter package amount" value="{{ $package->amount ?? '1' }}" required>
                                </div>
                                <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="file" class="form-control" name="image"
                                        placeholder="Enter package image" value="{{ $package->image ?? '' }}">
                                </div>
                            </div>
